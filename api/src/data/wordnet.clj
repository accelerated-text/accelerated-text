...
(defn lookup-words
  ...
  ([word pos]
   (log/debugf "Searching for Word: %s POS: %s" word pos)
   (some-> dictionary (.lookupIndexWord (log/spyf "looking up with POS: %s" (get gf-pos->wn-pos pos)) word) (index-word->map) (vector))))
