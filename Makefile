...
build-dynamodb-docker:
	...
	aws dynamodb create-table --table-name reader-flag --attribute-definitions AttributeName=key,AttributeType=S --key-schema AttributeName=id,KeyType=HASH --billing-mode=PAY_PER_REQUEST  --endpoint-url http://localhost:8000
