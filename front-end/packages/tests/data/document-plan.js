...
export const createDocumentPlan = ( prefix = 'tests-data-document-plan' ) => {
    ...
    return ({
        ...
        blocklyXml:         `<xml xmlns="http://www.w3.org/1999/xhtml"><block id="${ srcId }" type="Document-plan" deletable="false"><statement name="segments"><block id="${ segmentId }" type="Segment"><mutation value_count="2" value_sequence="value_"></mutation></block></statement></block></xml>`,
