...
(defn list-data [_ {:keys [user offset limit] :or {user "example-user" offset 0 limit 20}} _]
...
(defn get-data [_ {:keys [user file recordOffset recordLimit] :or {user "example-user" recordOffset 0 recordLimit 20}} _]
